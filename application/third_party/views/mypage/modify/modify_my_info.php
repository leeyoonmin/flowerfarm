...
<head>
    ...
    <script src="<?php echo base_url();?>/static/js/modifyMyInfo.js?ver=7"></script>
            ...
            <div class="main-wrapper mp-main-wrapper">
                <form action="modifyMyInfo" method="post">
                    <div class="login-input">
                        ...
                        <div class="field-wrap">
                            <div class="input-field">
                                <label class="input-field-label">
                                    <div class="input-field-input">
                                        <input class="member-input loginIdInput" name="pw" placeholder="비밀번호">
                                    </div>
                                </label>
                            </div>
                            <div class="expand-field">
                    ...
                    <div class="login-trigger-wrap">
                        ...
                        <input type="button" value="취소" class="login-trigger register">
                    </div>
                </form>
            </div>
        </section>
