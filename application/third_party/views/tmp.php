        ...
        <?php if(isset($_SESSION['cart'])){
            ...
            foreach($cart_items as $key => $item){
                ...
                <li data-pid="<?=$key?>" data-price="<?=$item['p_price']?>" data-name="<?=$item['p_name']?>">
                    ...
                    <p class="item-price"><?=$item['p_qty']*$item['p_price']?></p>
                </li>
                <?php
            }
        }
...
<table class="cart-amount-tb">
    ...
    <tr class="cart-row cart-prod-sum">
        <th>총금액</th>
        <td><span><?php if(isset($_SESSION['cart'])) { echo $amount; }else{ echo 0;}?></span> 원</td>
    </tr>
    ...
    <tr class="cart-sum">
        <th>합계</th>
        <td><span><?php if(isset($_SESSION['cart'])) { echo $amount+0; }else{ echo 0;}?></span> 원</td>
    </tr>
    </tbody>
</table>
