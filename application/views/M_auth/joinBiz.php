    ...
    <div class="box">
      ...
      <div class="formBox">
        <form class="joinFrm" action="/auth/joinPrc" method="post">
          ...
          <!--p>사업유형</p>
          <input class="width3" type="button" value="농가"><input class="width3" type="button" value="도매"><input class="width3 last" type="button" value="소매"-->
          <input class="inputBIZ_DV" type="hidden" name="type" value="6">
          <p>고객명</p>
          <input class="inputPresentNM" type="text" name="name" value="" placeholder="대표자명을 입력해주세요">
          <p>상호명</p>
          <input class="inputShopNM" type="text" name="shop_name" value="" placeholder="상호명을 입력해주세요">
          <p>전화번호</p>
          ...
          <p>사업자번호</p>
          <input class="inputBizNum" type="number" name="certificate_num" value="" placeholder="'-' 생략하고 입력해주세요" maxlength="10">
        </form>
      </div>
      <div class="agreeBox">
