<div class="wrap forderReceipt">

  <div class="divPageTitle">
    <table>
      <tr>
        <td class="engTitle">Flower Order Receipt</td><td class="hanTitle">발주품 수령</td><td></td>
      </tr>
    </table>
  </div>
  ...
  <div class="divButton box width100">
    <table>
      <tr>
        ...
        <td>
          <input class="btn purple completeFordertBtn" type="button" name="" value="발주서 보기">
        </td>
        <td>
          <input class="btn purple modifyFordertBtn" type="button" name="" value="수정발주서 보기">
        </td>
        <td>
          <input class="btn blue forderReceiptBtn" type="button" name="" value="발주품 수령완료">
        </td>
        <td>
          <input class="btn red forderReturnBtn" type="button" name="" value="발주품 반송">
        </td>
        <!--td>
  ...
  <div class="table">
    <div class="tr head">
      ...
      </div><div class="td wd150">발주요청일</div><div class="td wd250">발주번호</div><div class="td wd150">발주구분</div><div class="td wd300">상품명</div><div class="td wd150">판매금액</div><div class="td wd100">진행상태</div>
    </div>
    <?php
    $rowCnt = 0;
    if(empty($gridData)){
      ...
      foreach($gridData as $row){
        echo "<div class=\"tr body isCheck forder\">
          ...
          <div class=\"td wd150\">".$row->FORDER_DATE."</div><div class=\"td wd250 forderID\">".$row->ID."</div><div class=\"td wd150\">".$row->FORDER_NM."</div><div class=\"td wd300\">".$row->PRODUCT."</div><div class=\"td wd150\">".number_format($row->PAY_PRICE)." 원</div><div class=\"td wd100 prg\"><input type=\"hidden\" value=\"".$row->PROGRESS."\">".$row->PROGRESS_NM."</div>
        </div>";
        $rowCnt++;
      }
    }
