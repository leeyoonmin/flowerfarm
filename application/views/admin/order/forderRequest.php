<div class="wrap forderRequest">

  <div class="divPageTitle">
    <table>
      <tr>
        <td class="engTitle">Flower Order Request</td><td class="hanTitle">절화 발주 요청</td><td></td>
      </tr>
    </table>
  </div>
  ...
  <div class="divButton box width100">
    <table>
      <tr>
        <td></td>
        <td>
          <input class="btn blue forderDraftWriteBtn" type="button" name="" value="발주서작성">
        </td>
        <td>
    ...
    if(empty($gridData)){
      ...
      foreach($gridData as $row){
        ...
        echo "<div class=\"tr body isCheck order\">
          ...
          <div class=\"td wd150\">".$row->ORDER_TIME."</div><div class=\"td wd150 orderID\">".$row->ORDER_ID."</div><div class=\"td wd300\">".$row->PRODUCT."</div><div class=\"td wd150\">".$row->USER_ID."</div><div class=\"td wd150\">".number_format($row->PAY_PRICE)." 원</div><div class=\"td wd100\">".$row->IS_PAID."</div><div class=\"td wd100\">".$row->IS_FORDER."</div>
        </div>";
        $rowCnt++;
      }
    }
