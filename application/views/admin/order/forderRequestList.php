<div class="wrap forderRequestList">

  <div class="divPageTitle">
    <table>
      <tr>
        <td class="engTitle">Flower Order Request List</td><td class="hanTitle">절화발주 요청내역</td><td></td>
      </tr>
    </table>
  </div>
  ...
  <div class="divButton box width100">
    <table>
      <tr>
        ...
        <td>
          <input class="btn blue forderAcceptBtn" type="button" name="" value="발주접수">
        </td>
        <td>
          <input class="btn orange forderAcceptCCBtn" type="button" name="" value="발주접수취소">
        </td>
        <td>
          <input class="btn red forderCCBtn" type="button" name="" value="발주취소">
        </td>
        <!--td>
