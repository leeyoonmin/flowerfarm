        ...
        <?php
          ...
          foreach($gridData as $item){
            echo "<tr>
              ...
              <td class=\"documentInput qty variable\"><input type=\"text\" name=\"".$rowCnt."_qty\" value=\""; if($item->PURCHASED_AMOUNT != 0){echo number_format($item->PURCHASED_AMOUNT);}else{echo "0";} echo"\"  readonly></td>

              <td class=\"documentInput price variable\"><input type=\"text\" name=\"".$rowCnt."_price\" value=\""; if($item->PURCHASED_PRICE != 0){echo number_format($item->PURCHASED_PRICE);}else{echo "0";} echo"\"  readonly></td>
