...
<html lang="ko">
  ...
  <body>
    <div class="popup">
      <div class="header">
        <button class="printBtn btn" type="button" name="button">출력</button>
        <button class="forderRequestBtn btn" type="button" name="button">발주서 생성</button>
      </div>
      <table class="title">
        <tr>
    ...
    ?>
    <form class="forderWriteFrm" action="/admin/createForderServ" method="post">
    ...
    <script type="text/javascript">
      ...
      $('.header .forderRequestBtn').click(function(){
