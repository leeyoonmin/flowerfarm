...
<html lang="ko">
  ...
  <body id="printBody">
    <div class="popup">
        ...
        <?php
          ...
          foreach($gridData as $item){
            echo "<tr>
              ...
              <td class=\"documentInput price variable\"><input type=\"text\" name=\"".$rowCnt."_price\" value=\"".number_format($item->PRODUCT_PRICE)."\" readonly></td>
      ...
      <table class="sum">
        <tr>
          <td rowspan="3"><input type="hidden" name="FODID" value="">소계</td>
