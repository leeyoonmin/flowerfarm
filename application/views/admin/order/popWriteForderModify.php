        ...
        <?php
          ...
          foreach($gridData as $item){
            echo "<tr>
              ...
              <td class=\"documentInput qty variable\"><input type=\"text\" name=\"".$rowCnt."_qty\" value=\""; if($item->PURCHASED_AMOUNT != 0) echo number_format($item->PURCHASED_AMOUNT);{echo "";} echo"\" placeholder=\"".number_format($item->QTY)."\"></td>
              <td class=\"documentInput price variable\"><input type=\"text\" name=\"".$rowCnt."_price\" value=\""; if($item->PURCHASED_PRICE != 0) echo number_format($item->PURCHASED_PRICE); echo"\" placeholder=\"구매단가\"></td>
