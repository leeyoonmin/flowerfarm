    ...
    if(empty($gridData)){
      ...
      foreach($gridData as $row){
        ...
        echo "<div class=\"tr body isCheck order\">
          ...
          <div class=\"td wd100\">".($row->ORDER_TIME)."</div><div class=\"td wd200 orderID\">".$row->ORDER_ID."</div><div class=\"td wd250\">".$row->PRODUCT."</div><div class=\"td wd150\">".$row->USER_ID."</div><div class=\"td wd100\">".number_format($row->PAY_PRICE)." 원</div><div class=\"td wd100\">".$row->IS_PAID."</div><div class=\"td wd100\">".$row->ORDER_STAT_NM."</div><div class=\"td wd100 forderStat\"><input type=\"hidden\" value=\"".$row->FORDER_STAT."\">".$row->FORDER_STAT_NM."</div>
        </div>";
        $rowCnt++;
      }
    }
