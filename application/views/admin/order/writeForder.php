<div class="wrap writeForder">

  <div class="divPageTitle">
    <table>
      <tr>
        <td class="engTitle">발주서 작성</td>
      </tr>
    </table>
  </div>
  ...
  <div class="divButton box width100">
    <table>
      <tr>
        ...
        <td>
          <input class="btn blue writeForderBtn" type="button" name="" value="발주서 작성">
        </td>
        <td>
          <input class="btn red deleteForderBtn" type="button" name="" value="발주서 삭제">
        </td>
        <td>
