<div class="wrap setUserNick">

  <div class="divPageTitle">
    <table>
      <tr>
        <td class="engTitle">회원 별칭 지정</td><td></td>
      </tr>
    </table>
  </div>
  ...
  <div class="table">
    <div class="tr head">
      ...
      </div><div class="td wd150">가입일</div><div class="td wd150">아이디</div><div class="td wd150">이름</div><div class="td wd150">타입</div><div class="td wd150">사업자번호</div><div class="td wd100">사업자여부</div><div class="td wd150">별칭</div><div class="td wd100">저장버튼</div>
    </div>
    <?php
    $rowCnt = 0;
    if(empty($gridData)){
      ...
      foreach($gridData as $row){
        echo "<div class=\"tr body isCheck order\">
          ...
          <div class=\"td wd150\">".date('Y-m-d',strtotime($row->USER_CREATED))."</div><div class=\"td wd150 userID\">".$row->USER_ID."</div><div class=\"td wd150\">".$row->USER_NAME."</div><div class=\"td wd150\">".$row->USER_TYPE_NM."</div><div class=\"td wd150\">".$row->CERTI_NUM."</div><div class=\"td wd100\">".$row->IS_BIZ."</div><div class=\"td wd150\"><input style=\"width:120px;\" type=\"text\" value=\"".$row->USER_NICK."\"></div><div class=\"td wd100\"><input class=\"btn blue saveNickBtn\" type=\"button\" value=\"저장\"></div>
        </div>";
        $rowCnt++;
      }
    }
    ...
    <tr>
      ...
      <td>
        <select class="">
          ...
          <option value="4">소매</option>
          <option value="3">도매</option>
          <option value="2">농장</option>
          <option value="1">관리자</option>
        </select>
      </td>
    </tr>
    <tr>
      <td colspan="2" class="popupChangeGradeBtn">변경</td>
    </tr>
  </table>
</div>
