<div class="wrap userGradeMng">

  <div class="divPageTitle">
    <table>
      <tr>
        <td class="engTitle">User Grade Manager</td><td class="hanTitle">회원등급관리</td><td></td>
      </tr>
    </table>
  </div>
  ...
  <div class="divButton box width100">
    <table>
      <tr>
        <td></td>
        <td>
          <input class="btn blue changeGradeBtn" type="button" name="" value="등급변경">
        </td>
        <td>
